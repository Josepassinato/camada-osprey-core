...
**Pacote Completo (ZIP):**
```
https://visaflow-5.preview.emergentagent.com/api/download/package/Roberto_Silva_Mendes_I539_F1_COMPLETE_PACKAGE.zip
```

**Este Relatório (Markdown):**
```
https://visaflow-5.preview.emergentagent.com/api/download/report/RELATORIO_ROBERTO_SILVA_MENDES.md
```

**Listar Todos os Downloads:**
```
https://visaflow-5.preview.emergentagent.com/api/download/list
```
...
```bash
curl -X POST https://visaflow-5.preview.emergentagent.com/api/email/send-package \
...
**Website:** https://visaflow-5.preview.emergentagent.com
