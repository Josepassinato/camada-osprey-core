...
**Pacote Completo (ZIP):**
```
https://smart-visa-helper-1.preview.emergentagent.com/api/download/package/Roberto_Silva_Mendes_I539_F1_COMPLETE_PACKAGE.zip
```

**Este Relatório (Markdown):**
```
https://smart-visa-helper-1.preview.emergentagent.com/api/download/report/RELATORIO_ROBERTO_SILVA_MENDES.md
```

**Listar Todos os Downloads:**
```
https://smart-visa-helper-1.preview.emergentagent.com/api/download/list
```
...
```bash
curl -X POST https://smart-visa-helper-1.preview.emergentagent.com/api/email/send-package \
...
**Website:** https://smart-visa-helper-1.preview.emergentagent.com
