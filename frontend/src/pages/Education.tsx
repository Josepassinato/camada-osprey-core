            ...
            <CardContent>
              <div className="grid md:grid-cols-4 gap-6">
                ...
                <div className="text-center">
                  ...
                  <div className="text-2xl font-bold text-foreground">{progress?.interviews_completed?.length || 0}</div>
                ...
                <div className="text-center">
                  ...
                  <div className="text-2xl font-bold text-foreground">{progress?.total_study_time_minutes ? formatStudyTime(progress.total_study_time_minutes) : '0m'}</div>
                        ...
                        <div className="flex-1">
                          ...
                          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-sm">
                            ...
                            <div>
                              ...
                              <div className="font-medium">{guide.requirements?.length || 0} itens</div>
                            </div>
                            <div>
