...
REACT_APP_BACKEND_URL=https://visa-ai-assistant.preview.emergentagent.com
```

### **Frontend (.env)**
```bash
VITE_BACKEND_URL=https://visa-ai-assistant.preview.emergentagent.com
REACT_APP_BACKEND_URL=https://visa-ai-assistant.preview.emergentagent.com
```
...
- **Webhooks**: 
  - Endpoint: `https://visa-ai-assistant.preview.emergentagent.com/api/webhook/stripe`
