...
REACT_APP_BACKEND_URL=https://formcraft-43.preview.emergentagent.com
```

### **Frontend (.env)**
```bash
VITE_BACKEND_URL=https://formcraft-43.preview.emergentagent.com
REACT_APP_BACKEND_URL=https://formcraft-43.preview.emergentagent.com
```
...
- **Webhooks**: 
  - Endpoint: `https://formcraft-43.preview.emergentagent.com/api/webhook/stripe`
