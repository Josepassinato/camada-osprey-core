...
class FormValidator:
    def __init__(self):
        ...
        self.zip_to_state = {
            ...
            "77": "TX",
            "78": "TX",
            "79": "TX",  # Houston/Dallas area
            "33": "FL",
            "32": "FL",
            "34": "FL",  # Miami/Orlando area
        }
        ...
        if dob:
            try:
                ...
                if birth_date > today:
                    ...
                    suggestions.append(
                        "Menores de 16 anos podem precisar de documentação adicional"
                    )
        ...
        for i, trip in enumerate(trips):
            ...
            if departure_date and return_date:
                try:
                    ...
                    if years_ago > 10:
                        suggestions.append(
                            f"Viagem {i+1} foi há mais de 10 anos - pode não ser necessária"
                        )
