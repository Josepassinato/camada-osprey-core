...
class TranslationAgent:
    ...
    def translate_document(
        self, text: str, source_lang: str, target_lang: str, document_type: Optional[str] = None
    ) -> Dict:
        """
    ...
    def create_certified_translation(
        self,
        original_text: str,
        translated_text: str,
        source_lang: str,
            ...
            translations.append(
                {
                    ...
                    "translated": (
                        result.get("translated_text", "")[:100] + "..."
                        if len(result.get("translated_text", "")) > 100
                        else result.get("translated_text", "")
                    ),
