...
class TranslationGate:
    ...
    def _detect_languages(self, text: str) -> Dict[str, Any]:
        ...
        second_highest = (
            sorted(language_scores.values(), reverse=True)[1] if len(language_scores) > 1 else 0
        )
    ...
    def _calculate_language_score(
        self, text_clean: str, words: List[str], lang_config: Dict
    ) -> float:
        """
    ...
    def _analyze_compliance(
        self, language_scores: Dict[str, Any], translation_rule: Dict[str, Any], document_type: str
    ) -> Dict[str, Any]:
        """
    ...
    def _generate_recommendations(
        ...
        if primary_language == "portuguese" and translation_rule.get(
