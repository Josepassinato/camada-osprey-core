...
class TranslationService:
        ...
        try:
            ...
            for field, value in form_data.items():
                ...
                # Se for dict, processar recursivamente
                    ...
                    sub_result = await self.translate_form_data(value, source_language, field_contexts)
    ...
    def _create_translation_prompt(self, text: str, source_language: str, context: str = None) -> str:
...
Return ONLY the translated text, nothing else."""
    ...
    def _should_skip_translation(self, field: str, value) -> bool:
        ...
        skip_fields = [
            'id', 'case_id', 'user_id', 'email', 'phone', 'date', 'number',
            'passport_number', 'a_number', 'ssn', 'zip_code', 'postal_code',
            'country_code', 'area_code', 'extension',
