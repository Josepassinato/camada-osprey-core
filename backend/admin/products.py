...
async def update_product_price(
    db, visa_code: str, new_price: float, sync_stripe: bool = True
) -> Dict:
    """
    ...
    try:
        ...
        if not product:
            return {"success": False, "error": f"Produto {visa_code} não encontrado"}
    ...
    try:
        ...
        if not stripe_product_id:
            ...
            stripe_product = stripe.Product.create(
                ...
                metadata={"visa_code": visa_code, "category": product["category"]},
            )
        ...
        stripe_price = stripe.Price.create(
            ...
            currency="usd",
            metadata={"visa_code": visa_code, "updated_at": datetime.now(timezone.utc).isoformat()},
        )
...
async def sync_all_products_to_stripe(db) -> Dict:
    ...
    try:
        ...
        for product in products:
            ...
            results.append({"visa_code": visa_code, "result": result})
