...
def create_llm_client(system_message: str) -> LLMClient:
    """Create LLMClient instance with system message

    TODO: This is a temporary compatibility function. Should be refactored
    to use LLMClient directly throughout the module.
    """
    return LLMClient()
    ...
    "H-1B": {
        ...
        "categories": {
            "personal_info": {
                ...
                "required_fields": ["full_name", "dob", "passport", "current_address", "education"],
...
class CompletenessAnalyzer:
    ...
    async def analyze_field_quality(
        self, field_name: str, field_value: Any, field_context: str, visa_type: str
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            # TODO: Refactor to use LLMClient directly with proper async/await
    ...
    async def analyze_application_completeness(
        self, visa_type: str, user_data: Dict[str, Any], application_context: Optional[str] = None
    ) -> Dict[str, Any]:
        ...
        for category_key, category_info in requirements["categories"].items():
            ...
            for field in category_info["required_fields"]:
                ...
                field_analyses.append({"field": field, **field_analysis})
