...
class CrossDocumentConsistencyEngine:
    ...
    def _check_consistency_rule(
        self, rule_name: str, rule_config: Dict, organized_docs: Dict[str, Dict], case_context: Dict
    ) -> Optional[Dict]:
        """
    ...
    def _extract_field_values_for_consistency(
        self, doc_types: List[str], field_names: List[str], organized_docs: Dict[str, Dict]
    ) -> List[Dict]:
        """
    ...
    def _match_dates_exact(self, field_values: List[Dict], tolerance: float) -> Dict[str, Any]:
        ...
        for fv in field_values:
            ...
            normalized_dates.append(
                {"original": fv["value"], "normalized": normalized, "document": fv["document_type"]}
            )
    ...
    def _match_text_similarity(self, field_values: List[Dict], tolerance: float) -> Dict[str, Any]:
        ...
        return {
            ...
            "similarity_score": avg_similarity,
            "details": [
                {"value": fv["value"], "document": fv["document_type"]} for fv in field_values
            ],
    ...
    def _match_salary_range(self, field_values: List[Dict], tolerance: float) -> Dict[str, Any]:
        ...
        for fv in field_values:
            ...
            if amount:
                salary_values.append(
                    {"original": fv["value"], "amount": amount, "document": fv["document_type"]}
                )
        ...
        if len(salary_values) < 2:
            return {
                ...
                "details": "No valid salary amounts found",
            }
    ...
    def _generate_consistency_message(
        self, rule_name: str, match_result: Dict, documents: List[str]
    ) -> str:
        """
    ...
    def _generate_consistency_recommendations(
        self, consistency_results: List[Dict], critical_issues: List[Dict], warnings: List[Dict]
    ) -> List[Dict]:
        """
