...
class MongoDBBackup:
    ...
    def __init__(self, backup_dir: str = "/app/backups"):
        ...
        self.mongo_url = os.environ.get("MONGODB_URI") or os.environ.get(
        ...
        try:
            ...
            if process.returncode == 0:
                ...
                logger.info(
                    ...
                    extra={"backup_name": backup_name, "size_mb": round(size / 1024 / 1024, 2)},
                )
            ...
            logger.error(
                "mongodump not found. Install MongoDB tools: apt-get install mongodb-database-tools"
            )
            return {"success": False, "error": "mongodump not installed"}
        ...
        try:
            ...
            for backup_dir in self.backup_dir.iterdir():
                if backup_dir.is_dir() and backup_dir.name.startswith("backup_"):
                    ...
                    try:
                        timestamp_str = (
                            backup_dir.name.split("_")[-2] + backup_dir.name.split("_")[-1]
                        )
