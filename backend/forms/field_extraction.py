...
class FieldExtractionEngine:
    ...
    def extract_all_fields(
        self, text: str, policy_fields: List[Dict] = None, context: Dict[str, Any] = None
    ) -> Dict[str, Any]:
        """
    ...
    def _extract_field_type(
        self, text: str, field_type: str, config: Dict, context: Dict
    ) -> List[Dict]:
        """
            ...
            try:
                ...
                for match in matches:
                    ...
                    extraction = {
                        ...
                        "normalized_value": validation_result.get(
    ...
    def _extract_policy_fields(
        self, text: str, policy_fields: List[Dict], context: Dict
    ) -> Dict[str, Any]:
        """
    ...
    def _apply_field_validator(
        self, field_type: str, value: str, context: Dict, position_info: Dict
    ) -> Dict[str, Any]:
        """
    ...
    def _validate_passport_field(
        self, value: str, context: Dict, position_info: Dict
    ) -> Dict[str, Any]:
    ...
    def _validate_uscis_receipt_field(
        self, value: str, context: Dict, position_info: Dict
    ) -> Dict[str, Any]:
    ...
    def _validate_name_field(
        ...
        is_valid = (
            len(cleaned) >= 2
            and cleaned.replace(" ", "").replace("-", "").replace("'", "").isalpha()
        )
