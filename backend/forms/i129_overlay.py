...
class I129OverlayFiller:
    ...
    def fill_i129(
        ...
        try:
            ...
            logger.info(
                f"✅ I-129 preenchido: {filled_fields}/{total_fields} campos ({fill_rate:.1f}%)"
            )
    ...
    def _draw_checkbox(self, page: fitz.Page, x: float, y: float):
        ...
        try:
            ...
            page.draw_line((x, adjusted_y), (x + size, adjusted_y + size), color=(0, 0, 0), width=2)
            page.draw_line((x + size, adjusted_y), (x, adjusted_y + size), color=(0, 0, 0), width=2)
        except Exception as e:
    ...
    def map_friendly_data_to_i129(self, friendly_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        mapped["beneficiary_family_name"] = friendly_data.get("last_name") or friendly_data.get(
            "sobrenome"
        )
        mapped["beneficiary_given_name"] = friendly_data.get("first_name") or friendly_data.get(
            "nome"
        )
        mapped["beneficiary_middle_name"] = friendly_data.get("middle_name") or friendly_data.get(
            "nome_do_meio"
        )

        mapped["beneficiary_date_of_birth"] = friendly_data.get(
            "date_of_birth"
        ) or friendly_data.get("data_nascimento")
        mapped["beneficiary_country_of_birth"] = friendly_data.get(
            "country_of_birth"
        ) or friendly_data.get("pais_nascimento")
        mapped["beneficiary_country_of_citizenship"] = friendly_data.get(
            "citizenship"
        ) or friendly_data.get("nacionalidade")
        mapped["beneficiary_gender"] = friendly_data.get("gender") or friendly_data.get("sexo")

        # Passport
        mapped["beneficiary_passport_number"] = friendly_data.get(
            "passport_number"
        ) or friendly_data.get("numero_passaporte")
        mapped["beneficiary_passport_country"] = friendly_data.get(
            "passport_country"
        ) or friendly_data.get("pais_passaporte")
        mapped["beneficiary_passport_expiry"] = friendly_data.get(
            "passport_expiry"
        ) or friendly_data.get("validade_passaporte")

        # SSN and A-Number (if any)
        mapped["beneficiary_ssn"] = friendly_data.get("ssn")
        mapped["beneficiary_alien_number"] = friendly_data.get("alien_number") or friendly_data.get(
            "numero_a"
        )

        # I-94
        mapped["beneficiary_i94_number"] = friendly_data.get("i94_number") or friendly_data.get(
            "numero_i94"
        )

        # Current Status
        mapped["beneficiary_current_status"] = friendly_data.get(
            "current_status"
        ) or friendly_data.get("status_atual")
        mapped["beneficiary_status_expires"] = friendly_data.get(
            "status_expires"
        ) or friendly_data.get("status_expira")

        # US Address
        mapped["beneficiary_us_address_street"] = friendly_data.get(
            "us_address"
        ) or friendly_data.get("endereco_eua")
        mapped["beneficiary_us_city"] = friendly_data.get("us_city") or friendly_data.get(
            "cidade_eua"
        )
        mapped["beneficiary_us_state"] = friendly_data.get("us_state") or friendly_data.get(
            "estado_eua"
        )
        mapped["beneficiary_us_zip"] = friendly_data.get("us_zip") or friendly_data.get("cep_eua")

        # Petitioner (Employer) Information
        mapped["petitioner_name"] = friendly_data.get("employer_name") or friendly_data.get(
            "nome_empregador"
        )
        mapped["petitioner_address_street"] = friendly_data.get(
            "employer_address"
        ) or friendly_data.get("endereco_empregador")
        mapped["petitioner_city"] = friendly_data.get("employer_city") or friendly_data.get(
            "cidade_empregador"
        )
        mapped["petitioner_state"] = friendly_data.get("employer_state") or friendly_data.get(
            "estado_empregador"
        )
        mapped["petitioner_zip"] = friendly_data.get("employer_zip") or friendly_data.get(
            "cep_empregador"
        )
        mapped["petitioner_ein"] = friendly_data.get("employer_ein") or friendly_data.get(
            "ein_empregador"
        )
        mapped["petitioner_phone"] = friendly_data.get("employer_phone") or friendly_data.get(
            "telefone_empregador"
        )
        mapped["petitioner_email"] = friendly_data.get("employer_email") or friendly_data.get(
            "email_empregador"
        )

        # Employment Information
        mapped["job_title"] = friendly_data.get("job_title") or friendly_data.get("cargo")
        mapped["detailed_description"] = friendly_data.get("job_description") or friendly_data.get(
            "descricao_cargo"
        )
        mapped["job_start_date"] = friendly_data.get("job_start_date") or friendly_data.get(
            "data_inicio_trabalho"
        )
        mapped["job_end_date"] = friendly_data.get("job_end_date") or friendly_data.get(
            "data_fim_trabalho"
        )

        # Wage
        mapped["wage_rate_per_year"] = friendly_data.get("salary") or friendly_data.get(
            "salario_anual"
        )

        # Work location
        mapped["work_address_street"] = friendly_data.get("work_address") or friendly_data.get(
            "endereco_trabalho"
        )
        mapped["work_city"] = friendly_data.get("work_city") or friendly_data.get("cidade_trabalho")
        mapped["work_state"] = friendly_data.get("work_state") or friendly_data.get(
            "estado_trabalho"
        )
        ...
        # Dates
        mapped["requested_start_date"] = friendly_data.get(
            "requested_start_date"
        ) or friendly_data.get("data_inicio_pedido")
        mapped["requested_validity_from"] = friendly_data.get("validity_from") or friendly_data.get(
            "validade_de"
        )
        mapped["requested_validity_to"] = friendly_data.get("validity_to") or friendly_data.get(
            "validade_ate"
        )
