"""
Owl Agent - Intelligent Questionnaire Conductor

Intelligent guide for immigration form completion with contextual help,
...
class IntelligentOwlAgent(BaseAgent):
    ...
    async def process(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        Args:
            input_data: Dict containing:
                - action: "start_session", "get_guidance", "validate_input", etc.
                - case_id: Case identifier
                - visa_type: Visa type
                - field_id: Field identifier (for guidance)
                - user_input: User's input (for validation)
                - language: "pt" or "en"
        ...
        if action == "start_session":
            return await self.start_guided_session(
                ...
                user_language=input_data.get("language", "pt"),
            )
            ...
            return await self.get_field_guidance(
                ...
                visa_type=input_data.get("visa_type"),
                user_language=input_data.get("language", "pt"),
                current_value=input_data.get("current_value", ""),
    ...
    def _load_field_guides(self) -> Dict[str, FieldGuide]:
        ...
        guides["place_of_birth"] = FieldGuide(
            ...
            validation_rules={"required": True, "min_length": 5, "google_validation": True},
            importance_level=5,
            visa_specific=["ALL"],
        )
        ...
        guides["current_address"] = FieldGuide(
            ...
            validation_rules={"required": True, "min_length": 10, "cep_integration": True},
            importance_level=4,
            visa_specific=["ALL"],
        )
        ...
        guides["current_job"] = FieldGuide(
            ...
            validation_rules={"required": True, "min_length": 3, "h1b_validation": True},
            importance_level=5,
        ...
        guides["employer_name"] = FieldGuide(
            ...
            validation_rules={"required": True, "min_length": 2, "company_validation": True},
            importance_level=5,
        ...
        guides["highest_degree"] = FieldGuide(
            ...
            validation_rules={"required": True, "h1b_degree_check": True},
            importance_level=5,
        ...
        guides["marital_status"] = FieldGuide(
            ...
            validation_rules={"required": True, "family_visa_validation": True},
            importance_level=5,
        ...
        guides["previous_us_travel"] = FieldGuide(
            ...
            validation_rules={"required": True, "travel_history_validation": True},
            importance_level=4,
            visa_specific=["ALL"],
        )
        ...
        guides["immigration_violations"] = FieldGuide(
            ...
            examples=[
                "Não, nunca",
                "Sim, overstay em 2015 (explicar)",
                "Não aplicável - primeira visita",
            ],
            validation_rules={"required": True, "honesty_critical": True},
            importance_level=5,
            visa_specific=["ALL"],
        )
        ...
        guides["petition_receipt_number"] = FieldGuide(
            ...
            validation_rules={"format": "uscis_receipt", "uscis_validation": True},
            importance_level=4,
        ...
        guides["current_status"] = FieldGuide(
            ...
            validation_rules={"required": True, "pattern": r"^[A-Z][A-Z0-9-]{1,10}$"},
            importance_level=5,
            visa_specific=["I-539"],
        )
        ...
        guides["i94_number"] = FieldGuide(
            ...
            validation_rules={"required": True, "pattern": r"^\d{11}$", "length": 11},
            importance_level=5,
            visa_specific=["I-539"],
        )
        ...
        guides["entry_date"] = FieldGuide(
            ...
            validation_rules={"required": True, "format": "date", "max_date": "today"},
            importance_level=5,
            visa_specific=["I-539"],
        )
        ...
        guides["authorized_stay_until"] = FieldGuide(
            ...
            validation_rules={"required": True, "format": "date"},
            importance_level=5,
            visa_specific=["I-539"],
        )
        ...
        guides["extension_until"] = FieldGuide(
            ...
            validation_rules={"required": True, "format": "date", "min_date": "today+1day"},
            importance_level=5,
            visa_specific=["I-539"],
        )
        ...
        guides["extension_reason"] = FieldGuide(
            ...
            validation_rules={"required": True, "min_length": 50, "max_length": 1000},
            importance_level=5,
            visa_specific=["I-539"],
        )
        ...
        guides["passport_expiry"] = FieldGuide(
            ...
            validation_rules={"required": True, "format": "date", "min_date": "today+30days"},
            importance_level=4,
            visa_specific=["I-539", "ALL"],
        )
        ...
        guides["financial_support"] = FieldGuide(
            ...
            validation_rules={"required": True, "min_length": 30, "max_length": 500},
            importance_level=4,
            visa_specific=["I-539"],
        )
        ...
        guides["us_address"] = FieldGuide(
            ...
            validation_rules={"required": True, "min_length": 15, "us_address_validation": True},
            importance_level=4,
            visa_specific=["I-539", "ALL"],
        )
    ...
    async def start_guided_session(
        self, case_id: str, visa_type: str, user_language: str = "pt"
    ) -> Dict[str, Any]:
        ...
        first_guidance = (
            await self.get_field_guidance(first_field.field_id, visa_type, user_language)
            if first_field
            else None
        )
    ...
    async def _create_welcome_message(self, visa_type: str, language: str) -> Dict[str, Any]:
        ...
        message_text = visa_messages.get(language, visa_messages["pt"]).get(
            visa_type, visa_messages[language]["H-1B"]
        )
    ...
    async def get_field_guidance(
        ...
        guidance = {
            "field_id": field_id,
            "question": (
                field_guide.question_pt if user_language == "pt" else field_guide.question_en
            ),
            "explanation": (
                field_guide.explanation_pt if user_language == "pt" else field_guide.explanation_en
            ),
    ...
    async def _get_ai_contextual_guidance(
        self,
        ...
        """Get AI-powered contextual guidance using LLM client"""
        ...
        try:
            messages = [
                ChatMessage(
                    ...
                    content="You are an intelligent immigration assistant helping users with USCIS forms.",
                ),
                ChatMessage(role=MessageRole.USER, content=prompt),
            ]

            ai_guidance = await self._call_llm(messages=messages, max_tokens=300, temperature=0.7)

            return {"ai_guidance": ai_guidance, "ai_powered": True, "provider": "portkey"}
    ...
    def _get_proactive_tips(self, field_id: str, visa_type: str, language: str) -> List[str]:
        ...
        tips = {
            "pt": {
                "full_name": {
                    "H-1B": [
                        "Verifique se o nome no passaporte está atualizado",
                        "Nomes com acentos podem precisar adaptação",
                    ],
                    "F-1": ["O nome deve ser igual ao do I-20", "Certifique-se da grafia correta"],
                },
                "current_job": {
                    "H-1B": [
                        "O cargo deve exigir diploma universitário",
                        "Deve estar relacionado à sua formação",
                    ],
                },
                "employer_name": {
                    "H-1B": [
                        "Deve ser a empresa do LCA aprovado",
                        "Verifique se a empresa tem licença para patrocinar H-1B",
                    ],
                },
            },
            "en": {
                "full_name": {
                    "H-1B": [
                        "Verify passport name is current",
                        "Names with accents may need adaptation",
                    ],
                    "F-1": ["Name must match I-20", "Ensure correct spelling"],
                },
                "current_job": {
                    "H-1B": [
                        "Position must require university degree",
                        "Must be related to your education",
                    ],
                },
                "employer_name": {
                    "H-1B": [
                        "Must be the LCA approved company",
                        "Verify company has H-1B sponsorship license",
                    ],
                },
            },
        }
    ...
    async def validate_field_input(
        self,
        field_id: str,
        user_input: str,
        visa_type: str,
        ...
        if field_guide.validation_rules.get("google_validation") and user_input.strip():
            try:
                google_validation = await self._validate_with_google_api(
                    field_id, user_input, full_context
                )
        ...
        if user_input.strip():
            try:
                ai_validation = await self._validate_with_ai(
                    field_guide, user_input, visa_type, full_context
                )
        ...
        validation_result["user_message"] = self._generate_validation_message(
            validation_result, field_guide
        )
    ...
    def _validate_basic_rules(self, user_input: str, rules: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if user_input.strip():
            if rules.get("min_length") and len(user_input) < rules["min_length"]:
                result["basic_validation"]["valid"] = False
                result["basic_validation"]["errors"].append(
                    f"Mínimo {rules['min_length']} caracteres"
                )

            if rules.get("max_length") and len(user_input) > rules["max_length"]:
                result["basic_validation"]["valid"] = False
                result["basic_validation"]["errors"].append(
                    f"Máximo {rules['max_length']} caracteres"
                )
    ...
    async def _validate_with_google_api(
        self, field_id: str, user_input: str, context: Dict = None
    ) -> Dict[str, Any]:
    ...
    async def _validate_phone_with_google(self, phone: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "suggestions": (
                ["Use formato internacional: +55 (11) 99999-9999"] if not is_valid else []
            ),
    ...
    async def _validate_with_ai(
        self, field_guide: FieldGuide, user_input: str, visa_type: str, context: Dict = None
    ) -> Dict[str, Any]:
        ...
        try:
            messages = [
                ChatMessage(
                    role=MessageRole.SYSTEM,
                    content="You are an immigration form validation expert. Return responses in JSON format.",
                ),
                ChatMessage(role=MessageRole.USER, content=prompt),
            ]

            ai_response = await self._call_llm(messages=messages, max_tokens=200, temperature=0.3)
    ...
    def _generate_validation_message(
        self, validation_result: Dict[str, Any], field_guide: FieldGuide
    ) -> str:
    ...
    async def get_session_progress(self, session_id: str) -> Dict[str, Any]:
        ...
        valid_interactions = len(
            [i for i in interactions if i.validation_result.get("overall_score", 0) >= 70]
        )
    ...
    def _generate_session_recommendations(self, interactions: List[OwlInteraction]) -> List[str]:
        ...
        low_score_fields = [
            i.field_id for i in interactions if i.validation_result.get("overall_score", 0) < 70
        ]
        ...
        if duration > 30:
            recommendations.append(
                "Considere fazer uma pausa. Formulários longos podem gerar erros."
            )
        ...
        if problem_fields:
            recommendations.append(
                f"Campos com dificuldades: {', '.join(problem_fields)}. Consulte os exemplos."
            )
