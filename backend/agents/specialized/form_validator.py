...
class FormValidationAgent(BaseAgent):
    ...
    async def process(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return await self.validate_form(
            form_data=form_data, form_type=form_type, visa_type=visa_type
        )
    ...
    async def _get_knowledge_base_context(
        self, form_type: str, agent_role: str = "form_validation"
    ) -> str:
    ...
    async def validate_form(
        self, form_data: Dict[str, Any], form_type: str, visa_type: Optional[str] = None
    ) -> Dict[str, Any]:
        """
