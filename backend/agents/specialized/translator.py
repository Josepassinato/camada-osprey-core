...
class USCISFormTranslatorAgent(BaseAgent):
    ...
    async def process(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return await self.translate_form(
            friendly_form_data=friendly_form_data, target_uscis_form=target_uscis_form
        )
    ...
    async def translate_form(
        self, friendly_form_data: Dict[str, Any], target_uscis_form: str
    ) -> Dict[str, Any]:
...
def create_uscis_form_translator(
