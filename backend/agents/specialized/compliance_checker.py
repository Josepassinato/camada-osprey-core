...
class ComplianceCheckAgent(BaseAgent):
    ...
    async def process(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return await self.check_compliance(application_data=application_data, visa_type=visa_type)
    ...
    async def check_compliance(
        self, application_data: Dict[str, Any], visa_type: Optional[str] = None
    ) -> Dict[str, Any]:
