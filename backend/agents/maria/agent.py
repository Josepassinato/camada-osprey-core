    ...
    async def process(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        Returns:
            Dict containing:
                ...
                - emotion_detected: Detected emotion (if any)
                - requires_legal_advice: Whether question needs legal advice
                - requires_prediction: Whether question asks for predictions
        """
...
"""
    ...
    async def chat_stream(
        ...
        """
        Stream Maria's response in real-time for typing effect
        
        Yields chunks of text as they're generated by the LLM
        """
        try:
            # Preparar system prompt
            system_prompt = self.get_system_prompt()
...
"""
            ...
            yield "Desculpe, tive um probleminha técnico 😅 Pode tentar novamente?"
