...
class DraPaulaKnowledgeBase:
    ...
    def get_visa_specific_knowledge(self, visa_type: str) -> Dict[str, Any]:
        ...
        if visa_type in visa_mapping:
            ...
            return (
                self.knowledge_base["visa_types_expertise"].get(category, {}).get(specific_visa, {})
            )
    ...
    def get_document_guidance(self, document_type: str = None) -> Dict[str, Any]:
        ...
        if document_type:
            return self.knowledge_base["brazilian_specific_guidance"]["common_documents"].get(
                document_type, {}
            )
    ...
    def get_problem_solution(self, issue_type: str) -> Dict[str, Any]:
        ...
        return (
            self.knowledge_base["common_problems_solutions"]
            .get("inadmissibility_issues", {})
            .get(issue_type, {})
        )
